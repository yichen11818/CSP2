...
1. 前往 [Releases](https://github.com/yichen11818/csp2/releases) 页面(开发中 暂无发版)
...
| 框架 | 状态 | 说明 |
|------|------|------|
| Metamod:Source | ✅  已支持 | CS2 插件加载器基础 |
| CounterStrikeSharp | ✅ 已支持 | C# 插件开发框架 |
| Swiftly | 🚧 计划中 | 新兴插件框架 |
